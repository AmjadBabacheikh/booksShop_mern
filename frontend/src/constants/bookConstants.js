...
export const BOOK_ADD_REVIEW_REQUEST = 'BOOK_ADD_REVIEW_REQUEST';
export const BOOK_ADD_REVIEW_SUCCESS = 'BOOK_ADD_REVIEW_SUCCESS';
export const BOOK_ADD_REVIEW_FAIL = 'BOOK_ADD_REVIEW_FAIL';
export const BOOK_ADD_REVIEW_RESET = 'BOOK_ADD_REVIEW_RESET';
...
export const BOOK_TOPRATED_REQUEST = 'BOOK_TOPRATED_REQUEST';
export const BOOK_TOPRATED_SUCCESS = 'BOOK_TOPRATED_SUCCESS';
export const BOOK_TOPRATED_FAIL = 'BOOK_TOPRATED_FAIL';
